...
inparg = {'n':500,'m':500,'l_js':350, #number of grids: x,z+,z- below sample top
          'h0':0.1,'rho_max':10e6,'z_max':10e6, #resolution: h0, box_size (rho_max,z_max)
          'd_min':90,'d_max':110,'id_step':1, #tip-sample separation: min,max,istep (stepsize=istep*h0)
...
#===============================================================================
height_gap = np.arange(90,110+1,1)

for i in range(0,len(height_gap)):
    mesh_prefix = 'capsol/test6_s{:02.1f}nm'.format(height_gap[i])
    print(mesh_prefix)
